...
parser.add_argument('-n', '--number-of-estimators', dest='estimators', default='50', required=False,
...
regression = AdaBoostRegressor(base_estimator=DecisionTreeRegressor(max_depth=max_depth), n_estimators=estimators)
regression.fit(x, y)
